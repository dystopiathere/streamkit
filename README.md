...
1. Аналитика Twitch и YouTube поверх готовой абстракции провайдеров.
2. Остальные типы виджетов: цели, топ-донатеры, чат, таймер.
3. Приватные комнаты на LiveKit и виджет раскладки участников.
4. Собственный приём платежей — отдельный этап со своим анализом рисков.
