...
# Классы хостов баз — самые дорогие строки счёта. По умолчанию burstable
# (b3-c1-m4: 2 vCPU с гарантией 50 %, 4 ГБ): до первых платящих стримеров
# нагрузки на базы почти нет. Рост — сменой класса в tfvars, без переноса
# данных: s3-c2-m8 для PostgreSQL, hm3-c2-m8 для Valkey. Смена класса
