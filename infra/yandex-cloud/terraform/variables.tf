...
# Классы хостов баз — самые дорогие строки счёта. Valkey по умолчанию на
# burstable b3-c1-m4 (2 vCPU с гарантией 50 %, 4 ГБ): до первых платящих
# стримеров нагрузки почти нет. У PostgreSQL класса b3-c1-m4 нет, и он остаётся
# на s3-c2-m8. Рост — сменой класса в tfvars, без переноса данных: hm3-c2-m8
# для Valkey, s3-c4-m16 для PostgreSQL. Смена класса
