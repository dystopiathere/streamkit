...
export const LEGAL_DOCUMENTS: Record<ConsentDocument, LegalDocument> = {
  ...
  PRIVACY: {
    document: 'PRIVACY',
    // Шестая редакция: подключение DonationAlerts — что хранится об аккаунте
    // и что с почтой, которую сервис отдаёт в профиле (раздел 2). Пятая —
    // доступ сотрудников через административную панель. Согласившиеся со
    // старой увидят needsRenewal: это и есть смысл реестра версий.
    version: '2026-09-18',
