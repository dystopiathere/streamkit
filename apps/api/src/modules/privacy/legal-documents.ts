...
export const LEGAL_DOCUMENTS: Record<ConsentDocument, LegalDocument> = {
  ...
  PRIVACY: {
    document: 'PRIVACY',
    // Пятая редакция: доступ сотрудников через административную панель —
    // роли, второй фактор, журнал (раздел 10). Четвёртая — данные зрителей и
    // гостей обрабатываются по поручению стримера. Согласившиеся со старой
