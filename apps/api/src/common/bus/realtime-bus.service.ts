...
export type BusMessage =
  ...
  // Сообщение чата Kick, принятое вебхуком API. Адресат — источник чата в
  // воркере, а не браузер: только он знает, читается ли сейчас канал, и только
  // после него сообщение становится `chat`.
  | { kind: 'kick-chat'; message: ChatMessage }
