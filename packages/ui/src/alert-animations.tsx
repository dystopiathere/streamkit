 ...
 *
 * Комментариев внутри строки нет: для сборщика это данные, а не код, и они
 * уходили бы в прод как есть. Пояснения — здесь. Анимации продвинутого
 * оформления («Про», начиная с `sk-slide-down`) уходят зеркально входу: алерт,
 * приехавший сверху, уходит вверх — иначе движение читается как рывок.
 *
